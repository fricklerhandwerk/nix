...
The behaviour of the collector is also influenced by the [`keep-outputs`](@docroot@/command-ref/conf-file.md#conf-keep-outputs) and [`keep-derivations`](@docroot@/command-ref/conf-file.md#conf-keep-derivations) settings in the Nix configuration file.
